...
import { DavinciPicContractAttributes } from "../types/attributes";
...
const finalizeContractData = (
	options: DavinciPicContractAttributes,
...
export const finalizeSuccessfulContractData = (options: DavinciPicContractAttributes, remoteData: ContractEntity, failedPlaceholderColor: string, failedPlaceholderPicture: string) => {
...
export const finalizeFailedContractData = (options: DavinciPicContractAttributes, initialData: ContractEntity, failedPlaceholderColor: string, failedPlaceholderPicture: string) => {
