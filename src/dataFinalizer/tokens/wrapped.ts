...
import { getThemedBgColor, isTokenAllowedToHaveContext } from "../../modules/helpers";
import { getThemedPictureUrl } from "../../modules/helpers";

export const finalizeFailedWrappedData = (options: DavinciPicTokenAttributes, initialData: WrappedTokenEntity, failedPlaceholderColor: string, failedPlaceholderPicture: string) => {
...
export const finalizeSuccessfulWrappedData = (options: DavinciPicTokenAttributes, remoteData: WrappedTokenEntity, failedPlaceholderColor: string, failedPlaceholderPicture: string) => {
