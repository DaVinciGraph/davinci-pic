...
const generateBaseSvg = (
	...
	if (svg) {
		...
		setBaseBgRect(clonedSvg, supportingBackgroundColor, strokeWidth, options.shape);
		setBaseImage(clonedSvg, pictureUrl, uniqueID, strokeWidth);
